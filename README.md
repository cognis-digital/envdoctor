...
- **MCP server** — `envdoctor mcp` (Claude Desktop, Cursor, Cognis.Studio, [uncensored-fleet](https://github.com/cognis-digital/uncensored-fleet))
- **OpenAI-compatible / JSON** — pipe `envdoctor scan . --format json` into any agent or LLM
