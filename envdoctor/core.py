"""ENVDOCTOR core — .env validator, secret-presence and config-drift checker."""
...
RULES = [
    ("ENV-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("ENV-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("ENV-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
