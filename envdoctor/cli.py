...
import argparse, sys
from envdoctor.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="envdoctor", description="ENVDOCTOR — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from envdoctor.mcp_server import serve
        return serve()
    if args.cmd == "scan":
