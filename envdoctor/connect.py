"""Native cognis-connect emit for envdoctor — forward findings to any platform.

Maps envdoctor's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    envdoctor ... --format json | envdoctor-emit --to stix
    envdoctor-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
