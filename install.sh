#!/usr/bin/env sh
# Universal installer for envdoctor. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/envdoctor.git"
echo "Installing envdoctor ..."
